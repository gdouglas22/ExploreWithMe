...
class EventAdminControllerTest {
    ...
    void getEventsShouldReturnEventsCorrectly() throws Exception {
        ...
        mockMvc.perform(get("/admin/events")
                ...
                .andExpect(jsonPath("$.content[0].annotation").value("test"))
                .andExpect(jsonPath("$.content[0].category.id").value(10))
                .andExpect(jsonPath("$.content[0].category.name").value("category"))
                .andExpect(jsonPath("$.content[0].confirmedRequests").value(100))
                .andExpect(jsonPath("$.content[0].createdOn").value("2022-09-06 11:00:23"))
                .andExpect(jsonPath("$.content[0].description").value("description_test"))
                .andExpect(jsonPath("$.content[0].eventDate").value("2024-12-31 15:10:05"))
                .andExpect(jsonPath("$.content[0].id").value(1))
                .andExpect(jsonPath("$.content[0].initiator.id").value(2))
                .andExpect(jsonPath("$.content[0].initiator.name").value("user_test"))
                .andExpect(jsonPath("$.content[0].location.id").value(10))
                .andExpect(jsonPath("$.content[0].location.lat").value(55.754166))
                .andExpect(jsonPath("$.content[0].location.lon").value(37.62))
                .andExpect(jsonPath("$.content[0].paid").value(true))
                .andExpect(jsonPath("$.content[0].participantLimit").value(10))
                .andExpect(jsonPath("$.content[0].publishedOn").value("2022-09-06 15:10:05"))
                .andExpect(jsonPath("$.content[0].requestModeration").value(true))
                .andExpect(jsonPath("$.content[0].state").value("PUBLISHED"))
                .andExpect(jsonPath("$.content[0].title").value("test_title"))
                .andExpect(jsonPath("$.content[0].views").value(999))
